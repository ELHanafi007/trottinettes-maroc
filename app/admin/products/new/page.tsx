    ...
    <div className="space-y-10 max-w-5xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div>
          ...
          <h1 className="font-display text-4xl sm:text-5xl text-white">AJOUTER <span className="text-[#cc0000]">PRODUIT</span></h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white/[0.02] border border-white/5 p-8 sm:p-10 space-y-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            >
              <option value="" className="bg-[#0a0a0a]">Sélectionner une marque</option>
              {brands.map(brand => (
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative group">
              ...
              <div className="w-full bg-white/[0.02] border-2 border-dashed border-white/10 group-hover:border-[#cc0000]/50 py-12 flex flex-col items-center justify-center transition-all duration-300">
                ...
                <p className="text-white/40 text-[10px] font-black uppercase tracking-widest">Cliquer ou glisser pour uploader</p>
              </div>
            </div>
