    ...
    <div className="space-y-10 max-w-4xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div>
          ...
          <h1 className="font-display text-4xl sm:text-5xl text-white">AJOUTER <span className="text-[#cc0000]">MARQUE</span></h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <div className="relative flex-1 w-full group">
                ...
                <div className="w-full bg-white/[0.02] border-2 border-dashed border-white/10 group-hover:border-[#cc0000]/50 py-10 flex flex-col items-center justify-center transition-all duration-300">
                  ...
                  <p className="text-white/40 text-[10px] font-black uppercase tracking-widest">Uploader le logo</p>
                </div>
              </div>
              {logoPreview && (
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className={inputClass}
              placeholder="ex: Leader Mondial de la Mobilité"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="Description de la marque et son histoire..."
            />
          </div>
