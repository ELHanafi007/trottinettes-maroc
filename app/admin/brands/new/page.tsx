...
export default function NewBrandPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Add New Brand</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 max-w-2xl">
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900"
              placeholder="e.g., Segway-Ninebot"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900"
              placeholder="e.g., Leader Mondial de la Mobilité"
            />
          </div>
        ...
        <div className="mt-6 flex gap-4">
          ...
          <Link href="/admin/brands" className="text-gray-600 hover:text-gray-800">
            Cancel
          </Link>
        </div>
      </form>
