...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-[#0a0a0a] border-t border-black/10 dark:border-white/10 font-body" role="contentinfo">

      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16 grid grid-cols-1 md:grid-cols-4 gap-px bg-black/10 dark:bg-white/10">
          ...
          <div className="flex gap-2 sm:gap-3 flex-wrap">
            {[
              ...
              <a
                ...
                className="border border-black/10 dark:border-white/10 hover:border-[#cc0000] text-black/30 dark:text-white/30 hover:text-[#cc0000] text-[10px] sm:text-xs font-black px-2 sm:px-3 py-1.5 sm:py-2 uppercase tracking-widest transition-all duration-200"
              >
                {s.name}
              </a>
            ))}
        ...
        {/* Nav */}
        <div className="bg-white dark:bg-[#0a0a0a] p-6 sm:p-8">
          <h2 className="text-black/30 dark:text-white/30 font-black uppercase tracking-[0.3em] text-[10px] sm:text-xs mb-4 sm:mb-6">Navigation</h2>
          <nav aria-label="Footer navigation">
            <ul className="space-y-3 sm:space-y-4">
              {[
                ...
                <li key={l.label}>
                  <Link href={l.href} className="text-black/40 dark:text-white/40 hover:text-[#cc0000] font-black uppercase tracking-widest text-[10px] sm:text-xs transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
        ...
        {/* Contact */}
        <div className="bg-white dark:bg-[#0a0a0a] p-6 sm:p-8">
          <h2 className="text-black/30 dark:text-white/30 font-black uppercase tracking-[0.3em] text-[10px] sm:text-xs mb-4 sm:mb-6">Contact</h2>
